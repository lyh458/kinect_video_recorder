...
class Recorder:
    def __init__(self, path, rate=20, timeout=1):
        ...
        self.kinect_name = rospy.get_param('/recorder/kinect_name', 'kinectv1')
        self.kinect_rgb_sub = rospy.Subscriber(self.kinect_name + '/rgb/image_color', Image, self.cb_kinect_rgb, queue_size=1)
        self.kinect_depth_sub = rospy.Subscriber(self.kinect_name + '/depth_registered/disparity', DisparityImage, self.cb_kinect_depth, queue_size=1)
