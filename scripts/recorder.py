...
class Recorder:
    def __init__(self, path, rate=20, timeout=1):
        ...
        self.kinect_name = rospy.get_param('kinect_name', 'kinectv1')
        self.kinect_rgb_sub = rospy.Subscriber(self.kinect_name + '/ergb/image_color', Image, self.cb_kinect_rgb, queue_size=1)
